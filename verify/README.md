...
| Registry | Package |
|---|---|
| npm | `@particle-academy/google-calendar-js` (+ `@particle-academy/google-calendar-ui`, resolved transitively) |
...
npm install @particle-academy/google-calendar-js @particle-academy/fancy-flow
