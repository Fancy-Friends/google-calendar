...
it('channel_stop fakes the shape Google Calendar publishes', function () {
    $config = [];
    $fake = new FakeValues(FakeValues::seedForCall('google_calendar', 'channel_stop', $config));
...
it('channel_watch fakes the shape Google Calendar publishes', function () {
    $config = [];
...
it('event_get fakes the shape Google Calendar publishes', function () {
    $config = [];
...
it('event_list fakes the shape Google Calendar publishes', function () {
    $config = [];
...
it('events_changed fakes the shape Google Calendar publishes', function () {
    $config = [
        'sample' => 'exists',
    ];
...
it('throws for an operation with no fixture rather than inventing a shape', function () {
    $fake = new FakeValues(FakeValues::seedForCall('google_calendar', 'no_such_operation', []));

    expect(fn () => GoogleCalendarFaker::respond('no_such_operation', ['config' => [], 'fake' => $fake]))
